...
console.clear()
//console.log();
// changeGamersList("UserName446", ["gamer-add", "gamer-game-add"], "gameTitle", "gameCategory")

  
 
//#region FUNCTION changeGamersList() that create new item in the gamers list. Nothing to return, just aside affect with file gamers-base.
// Actions:
//  gamer-add
//  gamer-delete
//  gamer-game-add
...
function changeGamersList(UserName, actions, gameTitle, gameCategory) {
  ...
  for (let action of actions) {
    switch (action) {
      case 'gamer-add':
        if (!isUserNameExist(UserName, gamersList)) {
...
// console.log(isUserNameExist(UserName, gamersList));
}
